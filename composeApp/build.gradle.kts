...
val productName = "RecipeApp"
val productNameSpace = "org.jiffy.press"

buildConfig {
    packageName("composeapp.jiffy")
    ...
    buildConfigField("GITHUB_LINK", provider { "https://github.com/jifffffy/RecipeApp" })
}
...
kover.reports.filters.excludes {
    ...
    packages(
        listOf(
            ...
            "androidx",
            "recipeapp.composeapp.generated.*",
        ),
    )
}
